    ...
    return (
        <div className="w-full lg:w-1/2 px-4 mx-auto leading-loose list-disc font-sans">
            ...
            <p>
                ...
                emailing at [Contact Email] so we can try to find a solution.
            ...
            <p>
                ...
                or by emailing at [Contact Email].
            </p>
            ...
            <p>
                ...
                cancel it or s15n cancels it. You may cancel your Subscription
                renewal either through your online account management page or by
                contacting [Contact Email] customer support team.
            </p>
            <p>
                A valid payment method is required to process the payment for
                your subscription. You shall provide s15n with accurate and
                complete billing information that may include but not be limited
                to full name, address, state, postal or zip code, telephone
                number, and a valid payment method information. By submitting
                such payment information, you automatically authorize s15n to
                charge all Subscription fees incurred through your account to
                any such payment instruments.
            </p>
            <p>
                Should automatic billing fail to occur for any reason, s15n will
            ...
            <p>
                ...
                Free Trial, you will not be charged by s15n until the Free Trial
                has expired. On the last day of the Free Trial period, unless
                you canceled your Subscription, you will be automatically
                charged the applicable Subscription fees for the type of
                Subscription you have selected.
            </p>
            <p>
                At any time and without notice, s15n reserves the right to (i)
            ...
            <p>
                ...
                s15n on a case-by-case basis and granted at the sole discretion
                of s15n.
            </p>
            ...
            <p>
                s15n has the right but not the obligation to monitor and edit
                all Content provided by users.
            </p>
            <p>
                In addition, Content found on or through this Service are the
                property of s15n or used with permission. You may not
            ...
            <p>
                ...
                exclusive property of s15n and its licensors. Service is
                ...
                without the prior written consent of s15n.
            </p>
            ...
            <p>
                You may provide us either directly at [Contact Email] or via
            ...
            <p>
                ...
                services that are not owned or controlled by s15n.
            </p>
            <p>
                s15n has no control over, and assumes no responsibility for the
            ...
            <p>
                ...
                WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS OR
                ACCURACY OF THE SERVICES, THEIR CONTENT, OR THE CONTENT OF ANY
                WEBSITES LINKED TO THIS SERVICE. FURTHERMORE, NEITHER COMPANY
                NOR ANYONE ASSOCIATED WITH COMPANY REPRESENTS OR WARRANTS THAT
                THE SERVICES, THEIR CONTENT, OR ANY SERVICES OR ITEMS OBTAINED
                ...
                OTHER HARMFUL COMPONENTS, OR THAT THE SERVICES OR ANY SERVICES

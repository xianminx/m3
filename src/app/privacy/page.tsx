export default function Privacy() {
    return (
        <div className="w-full lg:w-1/2 px-4 mx-auto leading-loose list-disc">
            <h1 className="text-center text-lg">Privacy Policy</h1>
            <p>
            ...
            <p>
                When you visit our website [Website URL] and use our services,
                you trust us with your personal information. We take your
                privacy very seriously. In this privacy policy, we describe our
                privacy practices. We seek to explain to you in the clearest way
            ...
            <p>
                ...
                of your interactions with us and the Site, the choices you make
            ...
            <ul className="list-disc">
                ...
                <li>
                    ...
                    addresses; job titles; contact preferences; and other
                    similar information.
                </li>
                <li>
            ...
            <p>
                ...
                contact our Data Protection Officer (DPO), [DPO Name], by email
                at [DPO Email], or by post to:
            </p>
            <p>
                [Your Company Name]
                <br />

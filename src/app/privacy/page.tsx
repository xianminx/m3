export default function Privacy() {
    return (
        <article className="prose prose-zinc prose-base w-full lg:w-1/2 mx-auto leading-loose text-justify pt-8">
            ...
            <p>Last updated: 2024.08.08</p>

            <h2>1. Introduction</h2>
            <p>
                Welcome to s15n (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;)! We are committed
                to protecting your personal information and your right to privacy. If you have any questions or concerns
                about our policy, or our practices with regards to your personal information, please contact us at
                [Contact Information].
            </p>
            <p>
                When you visit our website [Website URL] and use our services, you trust us with your personal
                information. We take your privacy very seriously. In this privacy policy, we describe our privacy
                practices. We seek to explain to you in the clearest way possible what information we collect, how we
                use it, and what rights you have in relation to it. We hope you take some time to read through it
                carefully, as it is important. If there are any terms in this privacy policy that you do not agree with,
            ...
            <ul>
                ...
                <li>
                    ...
                    addresses; mailing addresses; job titles; contact preferences; and other similar information.
                </li>
                <li>
            ...
            <ul>
                {' '}
                <li>
                    <strong>To facilitate account creation and the logon process.</strong>
                </li>
                <li>
                ...
                <li>
                    <strong>To protect our Sites.</strong>
                </li>
                <li>
            ...
            <p>
                ...
                measures. However, despite our safeguards and efforts to secure your information, no electronic
            ...
            <p>
                ...
                [DPO Name], by email at [DPO Email], or by post to:
            </p>
            <p>
                [Your Company Name]
                <br />
